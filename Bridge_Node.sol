...
contract BridgeNode{
    ...
    function isValidator(address _user) private returns (bool){
    ...
    constructor (address _ERC721, address _contract_owner, TypeVariants _type) public{
    ...
    function onERC721Received(address _operator, address _from, uint8 _token_id) public {
        ...
        emit UserRequestforSignature(_from, _token_id, token_data);
    }
